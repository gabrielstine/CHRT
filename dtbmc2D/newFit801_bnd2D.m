function [logl,uscoh,t,P,pcorr] = newFit801_bnd2D(theta,data,opt)
%NEWFIT801_BND2D main function to perform DTB, Monte Carlo & FP4 fit
%
%   This function returns the -logL value of signed coherence data using
%   DTB, Monte Carlo or FP4 fit.
%
%   [logl,uscoh,t,P,pcorr] = newFit801_bnd2D(theta,data,opt)
%
%   where      
